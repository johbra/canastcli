...
var o23545 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23545["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23546 = temp__5455__auto____$1;
return (o23546["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22477__auto__ = f;
return (o__22477__auto__["toString"]).call(o__22477__auto__);
} else {
return "";
}
}catch (e23547){var _ = e23547;
return "";
}});
...
try{var o__22477__auto___23549 = t;
(o__22477__auto___23549["cljs$lang$ctorPrWriter"]).call(o__22477__auto___23549,t,writer);
}catch (e23548){var __23550 = e23548;
}
...
var char_code = (function (){var o__22477__auto__ = (new String(char$));
return (o__22477__auto__["charCodeAt"]).call(o__22477__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22477__auto__ = String;
return (o__22477__auto__["fromCharCode"]).call(o__22477__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23551 = num_code;
switch (G__23551) {
case (1):
return (185);
...
var o__22477__auto__ = String;
return (o__22477__auto__["fromCharCode"]).call(o__22477__auto__,superscript_code);
});
/**
...
}catch (e23553){var _e__22484__auto__ = e23553;
return false;
}})())){
...
var vec__23554 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23554,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23557 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23557["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23558 = temp__5455__auto____$1;
return (o23558["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23561){
var vec__23562 = p__23561;
var ns_detector = cljs.core.nth.call(null,vec__23562,(0),null);
...
var G__23568 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23569 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23568;
remaining_tokens = G__23569;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23559){
var G__23560 = cljs.core.first.call(null,seq23559);
var seq23559__$1 = cljs.core.next.call(null,seq23559);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23560,seq23559__$1);
});
...
var vec__23573 = cljs.core.split_with.call(null,(function (p1__23572_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23572_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23573,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23573,(1),null);
...
var vec__23576 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23576,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23576,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23579 = cljs.core.rest.call(null,remaining_tokens);
var G__23580 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23579;
name_tokens = G__23580;
continue;
} else {
...
var vec__23583 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23583,(0),null);
var arity = cljs.core.nth.call(null,vec__23583,(1),null);
var vec__23586 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23586,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23586,(1),null);
var vec__23589 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23589,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23589,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23589,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23589,(3),null);
...
var vec__23595 = result;
var munged_ns = cljs.core.nth.call(null,vec__23595,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23595,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23595,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23595,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23595,(4),null);
var arity = cljs.core.nth.call(null,vec__23595,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23599 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23599,(0),null);
var args = cljs.core.nth.call(null,vec__23599,(1),null);
var vec__23602 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23602,(0),null);
var name = cljs.core.nth.call(null,vec__23602,(1),null);
...
var G__23605 = (arity + (1));
var G__23606 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23607){
var vec__23608 = p__23607;
var arity = cljs.core.nth.call(null,vec__23608,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23608,(1),null);
...
return cljs.core.get.call(null,arities,p1__23611_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23612_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23615){
var vec__23616 = p__23615;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23616,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23613){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23624__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23624__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23624__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23624__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23625 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23625,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23625,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23625,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23625,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23625,(4),null);
var arity = cljs.core.nth.call(null,vec__23625,(5),null);
...
var o__22477__auto__ = f;
return (o__22477__auto__["getBasis"]).call(o__22477__auto__);
});
/**
...
}catch (e23629){var _e__22484__auto__ = e23629;
...
var G__23630 = (obj[cljs.core.first.call(null,path)]);
var G__23631 = cljs.core.rest.call(null,path);
obj = G__23630;
path = G__23631;
continue;
} else {
...
return (function (accum,p__23632){
var vec__23633 = p__23632;
var bit = cljs.core.nth.call(null,vec__23633,(0),null);
var protocol = cljs.core.nth.call(null,vec__23633,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23636){
var vec__23637 = p__23636;
var ns = cljs.core.nth.call(null,vec__23637,(0),null);
var name = cljs.core.nth.call(null,vec__23637,(1),null);
var selector = cljs.core.nth.call(null,vec__23637,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23642,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23642,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23642,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23640_SHARP_){
return (obj[cljs.core.first.call(null,p1__23640_SHARP_)]);
});})(name,sorted_matches,vec__23642,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
