...
var temp__5733__auto____$1 = (o23538["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23539 = temp__5733__auto____$1;
return (o23539["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22461__auto__ = f;
return (o__22461__auto__["toString"]).call(o__22461__auto__);
} else {
return "";
}
}catch (e23540){var _ = e23540;
return "";
}});
...
try{var o__22461__auto___23542 = t;
(o__22461__auto___23542["cljs$lang$ctorPrWriter"]).call(o__22461__auto___23542,t,writer);
}catch (e23541){var __23543 = e23541;
}
...
var char_code = (function (){var o__22461__auto__ = (new String(char$));
return (o__22461__auto__["charCodeAt"]).call(o__22461__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22461__auto__ = String;
return (o__22461__auto__["fromCharCode"]).call(o__22461__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23544 = num_code;
switch (G__23544) {
case (1):
return (185);
...
var o__22461__auto__ = String;
return (o__22461__auto__["fromCharCode"]).call(o__22461__auto__,superscript_code);
});
/**
...
}catch (e23546){var _e__22468__auto__ = e23546;
return false;
}})())){
...
var vec__23547 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23547,(0),null);
...
var temp__5733__auto____$1 = (o23550["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23551 = temp__5733__auto____$1;
return (o23551["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___23558 = arguments.length;
var i__4737__auto___23559 = (0);
while(true){
if((i__4737__auto___23559 < len__4736__auto___23558)){
args__4742__auto__.push((arguments[i__4737__auto___23559]));

var G__23560 = (i__4737__auto___23559 + (1));
i__4737__auto___23559 = G__23560;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23554){
var vec__23555 = p__23554;
var ns_detector = cljs.core.nth.call(null,vec__23555,(0),null);
...
var G__23561 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23562 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23561;
remaining_tokens = G__23562;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23552){
var G__23553 = cljs.core.first.call(null,seq23552);
var seq23552__$1 = cljs.core.next.call(null,seq23552);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23553,seq23552__$1);
}));
...
var vec__23566 = cljs.core.split_with.call(null,(function (p1__23565_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23565_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23566,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23566,(1),null);
...
var vec__23572 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23572,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23572,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23575 = cljs.core.rest.call(null,remaining_tokens);
var G__23576 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23575;
name_tokens = G__23576;
continue;
} else {
...
var vec__23579 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23579,(0),null);
var arity = cljs.core.nth.call(null,vec__23579,(1),null);
var vec__23582 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23582,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23582,(1),null);
var vec__23585 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23585,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23585,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23585,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23585,(3),null);
...
var vec__23591 = result;
var munged_ns = cljs.core.nth.call(null,vec__23591,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23591,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23591,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23591,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23591,(4),null);
var arity = cljs.core.nth.call(null,vec__23591,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__23595 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__23595,(0),null);
var args = cljs.core.nth.call(null,vec__23595,(1),null);
var vec__23598 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23598,(0),null);
var name = cljs.core.nth.call(null,vec__23598,(1),null);
...
var G__23601 = (arity + (1));
var G__23602 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23603){
var vec__23604 = p__23603;
var arity = cljs.core.nth.call(null,vec__23604,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23604,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23607_SHARP_){
return cljs.core.get.call(null,arities,p1__23607_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__23608_SHARP_){
return cljs.core.drop.call(null,(2),p1__23608_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23611){
var vec__23612 = p__23611;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23612,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23609){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23620__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23620__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23620__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23620__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23621 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23621,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23621,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23621,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23621,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23621,(4),null);
var arity = cljs.core.nth.call(null,vec__23621,(5),null);
...
var o__22461__auto__ = f;
return (o__22461__auto__["getBasis"]).call(o__22461__auto__);
});
/**
...
}catch (e23625){var _e__22468__auto__ = e23625;
...
var G__23626 = (obj[cljs.core.first.call(null,path)]);
var G__23627 = cljs.core.rest.call(null,path);
obj = G__23626;
path = G__23627;
continue;
} else {
...
var _STAR_ = (function (accum,p__23628){
var vec__23629 = p__23628;
var bit = cljs.core.nth.call(null,vec__23629,(0),null);
var protocol = cljs.core.nth.call(null,vec__23629,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23632){
var vec__23633 = p__23632;
var ns = cljs.core.nth.call(null,vec__23633,(0),null);
var name = cljs.core.nth.call(null,vec__23633,(1),null);
var selector = cljs.core.nth.call(null,vec__23633,(2),null);
...
var post_process = (function (p__23637){
var vec__23638 = p__23637;
var munged_name = cljs.core.nth.call(null,vec__23638,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23638,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23636_SHARP_){
return (obj[cljs.core.first.call(null,p1__23636_SHARP_)]);
}),sorted_matches);
