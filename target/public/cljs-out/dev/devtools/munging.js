...
var o14820 = temp__5733__auto__;
var temp__5733__auto____$1 = (o14820["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o14821 = temp__5733__auto____$1;
return (o14821["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13929__auto__ = f;
return (o__13929__auto__["toString"]).call(o__13929__auto__);
} else {
return "";
}
}catch (e14822){var _ = e14822;
return "";
}});
...
try{var o__13929__auto___14824 = t;
(o__13929__auto___14824["cljs$lang$ctorPrWriter"]).call(o__13929__auto___14824,t,writer);
}catch (e14823){var __14825 = e14823;
}
...
var char_code = (function (){var o__13929__auto__ = (new String(char$));
return (o__13929__auto__["charCodeAt"]).call(o__13929__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13929__auto__ = String;
return (o__13929__auto__["fromCharCode"]).call(o__13929__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14826 = num_code;
switch (G__14826) {
case (1):
return (185);
...
var o__13929__auto__ = String;
return (o__13929__auto__["fromCharCode"]).call(o__13929__auto__,superscript_code);
});
/**
...
}catch (e14828){var _e__13936__auto__ = e14828;
return false;
}})())){
...
var vec__14829 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14829,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o14832 = temp__5733__auto__;
var temp__5733__auto____$1 = (o14832["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o14833 = temp__5733__auto____$1;
return (o14833["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14836){
var vec__14837 = p__14836;
var ns_detector = cljs.core.nth.call(null,vec__14837,(0),null);
...
var G__14843 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14844 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14843;
remaining_tokens = G__14844;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14834){
var G__14835 = cljs.core.first.call(null,seq14834);
var seq14834__$1 = cljs.core.next.call(null,seq14834);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14835,seq14834__$1);
}));
...
var vec__14848 = cljs.core.split_with.call(null,(function (p1__14847_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14847_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14848,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14848,(1),null);
...
var vec__14854 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14854,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14854,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14857 = cljs.core.rest.call(null,remaining_tokens);
var G__14858 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14857;
name_tokens = G__14858;
continue;
} else {
...
var vec__14861 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14861,(0),null);
var arity = cljs.core.nth.call(null,vec__14861,(1),null);
var vec__14864 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14864,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14864,(1),null);
var vec__14867 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14867,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14867,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14867,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14867,(3),null);
...
var vec__14873 = result;
var munged_ns = cljs.core.nth.call(null,vec__14873,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14873,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14873,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14873,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14873,(4),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__14877 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__14877,(0),null);
var args = cljs.core.nth.call(null,vec__14877,(1),null);
var vec__14880 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__14880,(0),null);
var name = cljs.core.nth.call(null,vec__14880,(1),null);
...
var G__14883 = (arity + (1));
var G__14884 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14885){
var vec__14886 = p__14885;
var arity = cljs.core.nth.call(null,vec__14886,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14886,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__14889_SHARP_){
return cljs.core.get.call(null,arities,p1__14889_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__14890_SHARP_){
return cljs.core.drop.call(null,(2),p1__14890_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14893){
var vec__14894 = p__14893;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14894,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14891){
var G__14892 = cljs.core.first.call(null,seq14891);
var seq14891__$1 = cljs.core.next.call(null,seq14891);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14892,seq14891__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14902__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14902__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14902__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14902__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14903 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14903,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14903,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14903,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14903,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14903,(4),null);
var arity = cljs.core.nth.call(null,vec__14903,(5),null);
...
var o__13929__auto__ = f;
return (o__13929__auto__["getBasis"]).call(o__13929__auto__);
});
/**
...
}catch (e14907){var _e__13936__auto__ = e14907;
...
var G__14908 = (obj[cljs.core.first.call(null,path)]);
var G__14909 = cljs.core.rest.call(null,path);
obj = G__14908;
path = G__14909;
continue;
} else {
...
var _STAR_ = (function (accum,p__14910){
var vec__14911 = p__14910;
var bit = cljs.core.nth.call(null,vec__14911,(0),null);
var protocol = cljs.core.nth.call(null,vec__14911,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14914){
var vec__14915 = p__14914;
var ns = cljs.core.nth.call(null,vec__14915,(0),null);
var name = cljs.core.nth.call(null,vec__14915,(1),null);
var selector = cljs.core.nth.call(null,vec__14915,(2),null);
...
var post_process = (function (p__14919){
var vec__14920 = p__14919;
var munged_name = cljs.core.nth.call(null,vec__14920,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14920,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__14918_SHARP_){
return (obj[cljs.core.first.call(null,p1__14918_SHARP_)]);
}),sorted_matches);
