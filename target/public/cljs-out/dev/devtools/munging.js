...
var o21020 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21020["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21021 = temp__5733__auto____$1;
return (o21021["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20129__auto__ = f;
return (o__20129__auto__["toString"]).call(o__20129__auto__);
} else {
return "";
}
}catch (e21022){var _ = e21022;
return "";
}});
...
try{var o__20129__auto___21024 = t;
(o__20129__auto___21024["cljs$lang$ctorPrWriter"]).call(o__20129__auto___21024,t,writer);
}catch (e21023){var __21025 = e21023;
}
...
var char_code = (function (){var o__20129__auto__ = (new String(char$));
return (o__20129__auto__["charCodeAt"]).call(o__20129__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20129__auto__ = String;
return (o__20129__auto__["fromCharCode"]).call(o__20129__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21026 = num_code;
switch (G__21026) {
case (1):
return (185);
...
var o__20129__auto__ = String;
return (o__20129__auto__["fromCharCode"]).call(o__20129__auto__,superscript_code);
});
/**
...
}catch (e21028){var _e__20136__auto__ = e21028;
return false;
}})())){
...
var vec__21029 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21029,(0),null);
...
var temp__5733__auto____$1 = (o21032["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21033 = temp__5733__auto____$1;
return (o21033["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21036){
var vec__21037 = p__21036;
var ns_detector = cljs.core.nth.call(null,vec__21037,(0),null);
...
var G__21043 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21044 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21043;
remaining_tokens = G__21044;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21034){
var G__21035 = cljs.core.first.call(null,seq21034);
var seq21034__$1 = cljs.core.next.call(null,seq21034);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21035,seq21034__$1);
}));
...
var vec__21048 = cljs.core.split_with.call(null,(function (p1__21047_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21047_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21048,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21048,(1),null);
...
var vec__21054 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21054,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21054,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21057 = cljs.core.rest.call(null,remaining_tokens);
var G__21058 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21057;
name_tokens = G__21058;
continue;
} else {
...
var vec__21061 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21061,(0),null);
var arity = cljs.core.nth.call(null,vec__21061,(1),null);
var vec__21064 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21064,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21064,(1),null);
var vec__21067 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21067,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21067,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21067,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21067,(3),null);
...
var vec__21073 = result;
var munged_ns = cljs.core.nth.call(null,vec__21073,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21073,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21073,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21073,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21073,(4),null);
var arity = cljs.core.nth.call(null,vec__21073,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21077 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21077,(0),null);
var args = cljs.core.nth.call(null,vec__21077,(1),null);
var vec__21080 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21080,(0),null);
var name = cljs.core.nth.call(null,vec__21080,(1),null);
...
var G__21083 = (arity + (1));
var G__21084 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21085){
var vec__21086 = p__21085;
var arity = cljs.core.nth.call(null,vec__21086,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21086,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__21089_SHARP_){
return cljs.core.get.call(null,arities,p1__21089_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__21090_SHARP_){
return cljs.core.drop.call(null,(2),p1__21090_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___21097 = arguments.length;
var i__4737__auto___21098 = (0);
while(true){
if((i__4737__auto___21098 < len__4736__auto___21097)){
args__4742__auto__.push((arguments[i__4737__auto___21098]));

var G__21099 = (i__4737__auto___21098 + (1));
i__4737__auto___21098 = G__21099;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21093){
var vec__21094 = p__21093;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21094,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21091){
var G__21092 = cljs.core.first.call(null,seq21091);
var seq21091__$1 = cljs.core.next.call(null,seq21091);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21092,seq21091__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21102__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21102__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21102__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21102__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21103 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21103,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21103,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21103,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21103,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21103,(4),null);
var arity = cljs.core.nth.call(null,vec__21103,(5),null);
...
var o__20129__auto__ = f;
return (o__20129__auto__["getBasis"]).call(o__20129__auto__);
});
/**
...
}catch (e21107){var _e__20136__auto__ = e21107;
...
var G__21108 = (obj[cljs.core.first.call(null,path)]);
var G__21109 = cljs.core.rest.call(null,path);
obj = G__21108;
path = G__21109;
continue;
} else {
...
var _STAR_ = (function (accum,p__21110){
var vec__21111 = p__21110;
var bit = cljs.core.nth.call(null,vec__21111,(0),null);
var protocol = cljs.core.nth.call(null,vec__21111,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21114){
var vec__21115 = p__21114;
var ns = cljs.core.nth.call(null,vec__21115,(0),null);
var name = cljs.core.nth.call(null,vec__21115,(1),null);
var selector = cljs.core.nth.call(null,vec__21115,(2),null);
...
var post_process = (function (p__21119){
var vec__21120 = p__21119;
var munged_name = cljs.core.nth.call(null,vec__21120,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21120,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__21118_SHARP_){
return (obj[cljs.core.first.call(null,p1__21118_SHARP_)]);
}),sorted_matches);
