...
var o11353 = temp__5733__auto__;
var temp__5733__auto____$1 = (o11353["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o11354 = temp__5733__auto____$1;
return (o11354["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10462__auto__ = f;
return (o__10462__auto__["toString"]).call(o__10462__auto__);
} else {
return "";
}
}catch (e11355){var _ = e11355;
return "";
}});
...
try{var o__10462__auto___11357 = t;
(o__10462__auto___11357["cljs$lang$ctorPrWriter"]).call(o__10462__auto___11357,t,writer);
}catch (e11356){var __11358 = e11356;
}
...
var char_code = (function (){var o__10462__auto__ = (new String(char$));
return (o__10462__auto__["charCodeAt"]).call(o__10462__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10462__auto__ = String;
return (o__10462__auto__["fromCharCode"]).call(o__10462__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11359 = num_code;
switch (G__11359) {
case (1):
return (185);
...
var o__10462__auto__ = String;
return (o__10462__auto__["fromCharCode"]).call(o__10462__auto__,superscript_code);
});
/**
...
}catch (e11361){var _e__10469__auto__ = e11361;
return false;
}})())){
...
var vec__11362 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11362,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o11365 = temp__5733__auto__;
var temp__5733__auto____$1 = (o11365["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o11366 = temp__5733__auto____$1;
return (o11366["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___11373 = arguments.length;
var i__4737__auto___11374 = (0);
while(true){
if((i__4737__auto___11374 < len__4736__auto___11373)){
args__4742__auto__.push((arguments[i__4737__auto___11374]));

var G__11375 = (i__4737__auto___11374 + (1));
i__4737__auto___11374 = G__11375;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11369){
var vec__11370 = p__11369;
var ns_detector = cljs.core.nth.call(null,vec__11370,(0),null);
...
var G__11376 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11377 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11376;
remaining_tokens = G__11377;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11367){
var G__11368 = cljs.core.first.call(null,seq11367);
var seq11367__$1 = cljs.core.next.call(null,seq11367);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11368,seq11367__$1);
}));
...
var vec__11381 = cljs.core.split_with.call(null,(function (p1__11380_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11380_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11381,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11381,(1),null);
...
var vec__11387 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11387,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11387,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11390 = cljs.core.rest.call(null,remaining_tokens);
var G__11391 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11390;
name_tokens = G__11391;
continue;
} else {
...
var vec__11394 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11394,(0),null);
var arity = cljs.core.nth.call(null,vec__11394,(1),null);
var vec__11397 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11397,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11397,(1),null);
var vec__11400 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11400,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11400,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11400,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11400,(3),null);
...
var vec__11406 = result;
var munged_ns = cljs.core.nth.call(null,vec__11406,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11406,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11406,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11406,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11406,(4),null);
var arity = cljs.core.nth.call(null,vec__11406,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__11410 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__11410,(0),null);
var args = cljs.core.nth.call(null,vec__11410,(1),null);
var vec__11413 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11413,(0),null);
var name = cljs.core.nth.call(null,vec__11413,(1),null);
...
var G__11416 = (arity + (1));
var G__11417 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11418){
var vec__11419 = p__11418;
var arity = cljs.core.nth.call(null,vec__11419,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11419,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11422_SHARP_){
return cljs.core.get.call(null,arities,p1__11422_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__11423_SHARP_){
return cljs.core.drop.call(null,(2),p1__11423_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___11430 = arguments.length;
var i__4737__auto___11431 = (0);
while(true){
if((i__4737__auto___11431 < len__4736__auto___11430)){
args__4742__auto__.push((arguments[i__4737__auto___11431]));

var G__11432 = (i__4737__auto___11431 + (1));
i__4737__auto___11431 = G__11432;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11426){
var vec__11427 = p__11426;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11427,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11424){
var G__11425 = cljs.core.first.call(null,seq11424);
var seq11424__$1 = cljs.core.next.call(null,seq11424);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11425,seq11424__$1);
}));
...
var G__11433 = arg;
var G__11433__$1 = (((G__11433 instanceof cljs.core.Keyword))?G__11433.fqn:null);
switch (G__11433__$1) {
...
var map__11435 = options;
var map__11435__$1 = (((((!((map__11435 == null))))?(((((map__11435.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11435.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11435):map__11435);
var include_ns_QMARK_ = cljs.core.get.call(null,map__11435__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11435__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11435__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11435__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11436 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11436,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11436,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11436,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11436,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11436,(4),null);
var arity = cljs.core.nth.call(null,vec__11436,(5),null);
...
var o__10462__auto__ = f;
return (o__10462__auto__["getBasis"]).call(o__10462__auto__);
});
/**
...
}catch (e11440){var _e__10469__auto__ = e11440;
...
var G__11441 = (obj[cljs.core.first.call(null,path)]);
var G__11442 = cljs.core.rest.call(null,path);
obj = G__11441;
path = G__11442;
continue;
} else {
...
var _STAR_ = (function (accum,p__11443){
var vec__11444 = p__11443;
var bit = cljs.core.nth.call(null,vec__11444,(0),null);
var protocol = cljs.core.nth.call(null,vec__11444,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11447){
var vec__11448 = p__11447;
var ns = cljs.core.nth.call(null,vec__11448,(0),null);
var name = cljs.core.nth.call(null,vec__11448,(1),null);
var selector = cljs.core.nth.call(null,vec__11448,(2),null);
...
var post_process = (function (p__11452){
var vec__11453 = p__11452;
var munged_name = cljs.core.nth.call(null,vec__11453,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11453,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11451_SHARP_){
return (obj[cljs.core.first.call(null,p1__11451_SHARP_)]);
}),sorted_matches);
