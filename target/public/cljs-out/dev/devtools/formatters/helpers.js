...
var G__14925 = devtools.prefs.pref.call(null,v);
v = G__14925;
continue;
} else {
return v;
...
}catch (e14928){var _e__13936__auto__ = e14928;
return false;
}})();
...
}catch (e14932){var _e__13936__auto__ = e14932;
return false;
}})();
...
}catch (e14934){var _e__13936__auto__ = e14934;
return false;
}}
}
});
...
var vec__14936 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
...
return cljs.core.some.call(null,(function (p1__14939_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14939_SHARP_);
}),template);
});
