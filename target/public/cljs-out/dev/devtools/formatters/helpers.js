...
var G__21137 = devtools.prefs.pref.call(null,v);
v = G__21137;
continue;
} else {
return v;
...
}catch (e21140){var _e__20148__auto__ = e21140;
return false;
}})();
...
}catch (e21144){var _e__20148__auto__ = e21144;
return false;
}})();
...
}catch (e21146){var _e__20148__auto__ = e21146;
return false;
}}
}
});
...
var vec__21148 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21148,(0),null);
var name = cljs.core.nth.call(null,vec__21148,(1),null);
...
return cljs.core.some.call(null,(function (p1__21151_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21151_SHARP_);
}),template);
});
