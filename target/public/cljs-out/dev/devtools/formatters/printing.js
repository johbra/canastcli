...
var len__4736__auto___21154 = arguments.length;
var i__4737__auto___21155 = (0);
while(true){
if((i__4737__auto___21155 < len__4736__auto___21154)){
args__4742__auto__.push((arguments[i__4737__auto___21155]));

var G__21156 = (i__4737__auto___21155 + (1));
i__4737__auto___21155 = G__21156;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21151){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21152,G__21153,seq21151__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21157_SHARP_){
return (!((cljs.core.meta.call(null,p1__21157_SHARP_) == null)));
})))){
...
var map__21158 = opts;
var map__21158__$1 = (((((!((map__21158 == null))))?(((((map__21158.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21158.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21158):map__21158);
var markup_db = cljs.core.get.call(null,map__21158__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21162){var _e__20136__auto__ = e21162;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e21164){var _e__20136__auto__ = e21164;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__21166 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__21167 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__21167);

try{var map__21168 = opts;
var map__21168__$1 = (((((!((map__21168 == null))))?(((((map__21168.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21168.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21168):map__21168);
var markup_db = cljs.core.get.call(null,map__21168__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__21166);
}});
...
var temp__5733__auto___21173 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___21173)){
var managed_print_level_21174 = temp__5733__auto___21173;
var _STAR_print_level_STAR__orig_val__21171_21175 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21172_21176 = managed_print_level_21174;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21172_21176);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__21170_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21170_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21171_21175);
}} else {
job_fn.call(null);
}
