...
var len__4736__auto___21166 = arguments.length;
var i__4737__auto___21167 = (0);
while(true){
if((i__4737__auto___21167 < len__4736__auto___21166)){
args__4742__auto__.push((arguments[i__4737__auto___21167]));

var G__21168 = (i__4737__auto___21167 + (1));
i__4737__auto___21167 = G__21168;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21163){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21164,G__21165,seq21163__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21169_SHARP_){
return (!((cljs.core.meta.call(null,p1__21169_SHARP_) == null)));
})))){
...
var map__21170 = opts;
var map__21170__$1 = (((((!((map__21170 == null))))?(((((map__21170.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21170.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21170):map__21170);
var markup_db = cljs.core.get.call(null,map__21170__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21174){var _e__20148__auto__ = e21174;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e21176){var _e__20148__auto__ = e21176;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__21178 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__21179 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__21179);

try{var map__21180 = opts;
...
var markup_db = cljs.core.get.call(null,map__21180__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__21178);
}});
...
var temp__5733__auto___21185 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___21185)){
var managed_print_level_21186 = temp__5733__auto___21185;
var _STAR_print_level_STAR__orig_val__21183_21187 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21184_21188 = managed_print_level_21186;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21184_21188);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__21182_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21182_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21183_21187);
}} else {
job_fn.call(null);
}
