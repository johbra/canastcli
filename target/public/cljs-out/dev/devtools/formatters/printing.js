...
var len__4736__auto___14954 = arguments.length;
var i__4737__auto___14955 = (0);
while(true){
if((i__4737__auto___14955 < len__4736__auto___14954)){
args__4742__auto__.push((arguments[i__4737__auto___14955]));

var G__14956 = (i__4737__auto___14955 + (1));
i__4737__auto___14955 = G__14956;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14951){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14952,G__14953,seq14951__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14957_SHARP_){
return (!((cljs.core.meta.call(null,p1__14957_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__14958__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e14962){var _e__13936__auto__ = e14962;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e14964){var _e__13936__auto__ = e14964;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__14966 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__14967 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__14967);

try{var map__14968 = opts;
...
var markup_db = cljs.core.get.call(null,map__14968__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__14966);
}});
...
var temp__5733__auto___14973 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___14973)){
var managed_print_level_14974 = temp__5733__auto___14973;
var _STAR_print_level_STAR__orig_val__14971_14975 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14972_14976 = managed_print_level_14974;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14972_14976);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__14970_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__14970_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14971_14975);
}} else {
job_fn.call(null);
}
