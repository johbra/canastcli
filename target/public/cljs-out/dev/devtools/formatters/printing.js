...
var len__4736__auto___11487 = arguments.length;
var i__4737__auto___11488 = (0);
while(true){
if((i__4737__auto___11488 < len__4736__auto___11487)){
args__4742__auto__.push((arguments[i__4737__auto___11488]));

var G__11489 = (i__4737__auto___11488 + (1));
i__4737__auto___11488 = G__11489;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11484){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11485,G__11486,seq11484__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11490_SHARP_){
return (!((cljs.core.meta.call(null,p1__11490_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__11491__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11495){var _e__10469__auto__ = e11495;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e11497){var _e__10469__auto__ = e11497;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11499 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11500 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11500);

try{var map__11501 = opts;
...
var markup_db = cljs.core.get.call(null,map__11501__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11499);
}});
...
var temp__5733__auto___11506 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___11506)){
var managed_print_level_11507 = temp__5733__auto___11506;
var _STAR_print_level_STAR__orig_val__11504_11508 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11505_11509 = managed_print_level_11507;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11505_11509);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__11503_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__11503_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11504_11508);
}} else {
job_fn.call(null);
}
