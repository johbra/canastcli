...
var G__13336 = o;
goog.object.set(G__13336,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__13337__delegate = function (args){
...
while (G__13338__i < G__13338__a.length) {G__13338__a[G__13338__i] = arguments[G__13338__i + 0]; ++G__13338__i;}
  args = new cljs.core.IndexedSeq(G__13338__a,0,null);
} 
return G__13337__delegate.call(this,args);};
G__13337.cljs$lang$maxFixedArity = 0;
G__13337.cljs$lang$applyTo = (function (arglist__13339){
var args = cljs.core.seq(arglist__13339);
return G__13337__delegate(args);
});
...
var G__13340 = o;
goog.object.set(G__13340,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__13344 = props;
var G__13344__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__13344,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__13344);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__13344__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__13345 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__13345,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__13345;
}
})(),id_class);
...
var G__13346 = (cljs.core.count.call(null,argv) - first_child);
switch (G__13346) {
case (0):
...
var className = cljs.core.nth.call(null,vec__13348,(2),null);
...
var temp__5739__auto___13351 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___13351 == null)){
} else {
var key_13352 = temp__5739__auto___13351;
(jsprops.key = key_13352);
}
...
var temp__5739__auto___13353 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___13353 == null)){
} else {
var key_13354 = temp__5739__auto___13353;
(jsprops.key = key_13354);
}
...
var temp__5739__auto___13355 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___13355 == null)){
} else {
var key_13356 = temp__5739__auto___13355;
(jsprops.key = key_13356);
}
...
var temp__5739__auto___13357 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___13357 == null)){
} else {
var key_13358 = temp__5739__auto___13357;
(jsprops.key = key_13358);
}
...
var temp__5739__auto___13359 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___13359 == null)){
} else {
var key_13360 = temp__5739__auto___13359;
(jsprops.key = key_13360);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__13361_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__13361_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__13362 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__13362,(0),null);
var derefed = cljs.core.nth.call(null,vec__13362,(1),null);
...
break;
default:
var G__13367 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__13368 = compiler;
v = G__13367;
compiler = G__13368;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template13372 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template13372 = (function (opts,id,fn_to_element,meta13373){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template13372.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13374,meta13373__$1){
var self__ = this;
var _13374__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template13372(self__.opts,self__.id,self__.fn_to_element,meta13373__$1));
}));

(reagent.impl.template.t_reagent$impl$template13372.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13374){
var self__ = this;
var _13374__$1 = this;
return self__.meta13373;
}));

(reagent.impl.template.t_reagent$impl$template13372.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template13372.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template13372.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template13372.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template13372.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta13373","meta13373",1336510169,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template13372.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template13372.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template13372");

(reagent.impl.template.t_reagent$impl$template13372.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template13372");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template13372.
 */
reagent.impl.template.__GT_t_reagent$impl$template13372 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template13372(opts__$1,id__$1,fn_to_element__$1,meta13373){
return (new reagent.impl.template.t_reagent$impl$template13372(opts__$1,id__$1,fn_to_element__$1,meta13373));
});

}

return (new reagent.impl.template.t_reagent$impl$template13372(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
