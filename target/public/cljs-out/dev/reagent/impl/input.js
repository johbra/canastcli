...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__19910){
var map__19911 = p__19910;
var map__19911__$1 = (((((!((map__19911 == null))))?(((((map__19911.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19911.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19911):map__19911);
var on_write = cljs.core.get.call(null,map__19911__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__19913_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__19913_SHARP_);
}));
