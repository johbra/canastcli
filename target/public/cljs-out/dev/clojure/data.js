...
return cljs.core.reduce.call(null,(function (result,p__16267){
var vec__16268 = p__16267;
var k = cljs.core.nth.call(null,vec__16268,(0),null);
var v = cljs.core.nth.call(null,vec__16268,(1),null);
...
var vec__16271 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__16271,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__16271,(1),null);
var ab = cljs.core.nth.call(null,vec__16271,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_16277 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_16277.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_16278 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_16278.call(null,a,b);
}
});
...
return (function (){var G__16282 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16282__$1)].join('')));
